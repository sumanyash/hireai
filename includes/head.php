...
:root{
  ...
  --blue:#6B21A8;--blue2:#7C3AED;--blue3:#A78BFA;
  --accent:#2563EB;--green:#10B981;--orange:#F59E0B;
  ...
  --card-shadow-hover:0 8px 32px rgba(107,33,168,.15),0 2px 8px rgba(0,0,0,.08);
  --radius:16px;--radius-sm:10px;
}
*,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{font-family:'Inter',system-ui,sans-serif;background:var(--bg);color:var(--text);line-height:1.5;-webkit-font-smoothing:antialiased;overflow-x:hidden}
...
.nav-links a.active{background:rgba(107,33,168,.2);color:var(--blue3);border:1px solid rgba(107,33,168,.3)}
...
/* BUTTONS */
.btn-primary{background:linear-gradient(135deg,#6B21A8,#7C3AED);color:#fff;padding:10px 22px;border-radius:var(--radius-sm);border:none;cursor:pointer;font-size:14px;font-weight:600;display:inline-flex;align-items:center;gap:7px;transition:all .2s;box-shadow:0 4px 14px rgba(107,33,168,.35);white-space:nowrap}
.btn-primary:hover{transform:translateY(-1px);box-shadow:0 6px 22px rgba(107,33,168,.45);color:#fff}
.btn-primary-sm{background:linear-gradient(135deg,#6B21A8,#7C3AED);color:#fff;padding:6px 14px;border-radius:8px;border:none;cursor:pointer;font-size:13px;font-weight:600;display:inline-flex;align-items:center;gap:5px;transition:all .2s;box-shadow:0 2px 8px rgba(107,33,168,.25);white-space:nowrap}
.btn-primary-sm:hover{transform:translateY(-1px);color:#fff}
.btn-sm{color:var(--blue);padding:6px 14px;border-radius:8px;border:1.5px solid rgba(107,33,168,.25);font-size:13px;font-weight:600;display:inline-flex;align-items:center;gap:5px;background:rgba(107,33,168,.04);cursor:pointer;transition:all .2s;white-space:nowrap}
...
.form-control:focus{border-color:var(--blue);box-shadow:0 0 0 3px rgba(107,33,168,.1)}
...
@media(max-width:768px){
  ...
  .navbar{height:auto;min-height:66px;padding:10px 12px;flex-wrap:wrap;gap:8px}
  .nav-logo-text{font-size:17px}
  .nav-links{order:3;width:100%;display:flex;gap:6px;overflow-x:auto;padding-bottom:2px}
  ...
  .btn-primary,.btn-green,.btn-outline,.btn-sm{max-width:100%;white-space:normal;text-align:center;justify-content:center}
}
