...
function startAntiCheat() {
  ...
  ta.addEventListener('paste', e => {
    ...
    logCheat('Paste detected (' + txt.length + ' chars)');
    document.getElementById('paste-warn').style.display = 'inline';
    setTimeout(() => document.getElementById('paste-warn').style.display = 'none', 4000);
  });
...
function logCheat(msg) {
  ...
  // Intentionally NOT displayed to candidate
}
</script>
</body>
</html>
